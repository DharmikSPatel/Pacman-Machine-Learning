...
public class PacmanAgent : Agent
{
    ...
    {
        Debug.Log("On Episode Start Start");
        Destroy(curBoard);
        curBoard = Instantiate(initialBoard, transform.parent);
        //transform.position = pacmanStartPos; //to random 
        //transform.position = getPacmanRandomPos();
        ...
        if(pelletsInScene != initialNumberPeletsWanted)
        {
            Debug.Log("Not all peletes were generated. Due to a infinte loop");
        }
        curTimer = originalTimer;
        Debug.Log("On Episode Start End");
    ...
    public Vector3 getPacmanRandomPos()
    {
        ...
        {
            Debug.Log("RAND: Pacman Spawn at " + possibleSpawnPosition);
            return possibleSpawnPosition;
        }
        else
        {
            Debug.Log("RAND: Pacman Spawn at default pos");
    ...
    public void randomPelletSpawning(Transform peletGroup, int spawnR, int initialPeletsWanted)
    {
        ...
        float curBoardHeightMax = curBoard.transform.position.x + 2.5f;
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        Debug.Log("Closet Pelet Pos: " + (pelets.Length != 0 ? getClosestPellet(pelets).localPosition : Vector3.zero));
    ...
    {
        Debug.Log("OnActionReceived Start");
        ...
        checkWin();
        Debug.Log("checkWin end end" + curBoard.transform.GetChild(1).transform.childCount + curBoard.transform.GetChild(1));
    ...
    public void checkWin()
    {
        ...
        Debug.Log("checkWin Start" + curBoard.transform.GetChild(1).transform.childCount + curBoard.transform.GetChild(1));
        ...
        Debug.Log("checkWin end" + curBoard.transform.GetChild(1).transform.childCount + curBoard.transform.GetChild(1));
